...
// Can be configured via HUSHBEAM_OLLAMA_MODELS or OLLAMA_MODELS environment variables.
// Default is ~/Library/Application Support/app.reckr.hushbeam.macos/Models
func Models() string {
